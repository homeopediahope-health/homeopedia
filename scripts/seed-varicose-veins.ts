  ...
  medicines: [
    {
      ...
      forWhom: 'Jinhein tangon mein bruised, sore feeling ho, veins dard karti hon, aur touch se takleef badhti ho — varicose veins ke saath bleeding tendency bhi ho to.',
    ...
    },
    {
      ...
      forWhom: 'Mostly women patients — jinhein pregnancy ke dauran ya periods ke time varicose veins worse ho jaati hain; legs mein heaviness aur pain jo movement se thoda better ho, open air se acha lage.',
    ...
    },
    {
      ...
      forWhom: 'Jinhein vein walls ki chronic weakness ho, jo log lamba time khade rehte hain, aur veins hard ya knotty feel hon — tissue nutrition aur elasticity loss ke cases mein.',
    ...
    },
    {
      ...
      forWhom: 'Jinhein legs mein extreme heaviness aur bluish discoloration ho, circulation very sluggish lage, aur varicose veins ke saath general weakness bhi ho — elderly patients ya debilitated state mein.',
    ...
    },
    {
      _key: 'med5',
      name: 'Vipera Berus',
      forWhom: 'Jinhein leg neeche latkane pe unbearable dard ho aur upar uthane pe relief mile — varicose veins mein severe pain aur swelling ke cases mein.',
