...
const doc = {
  ...
  medicines: [
    {
      _key: 'med1',
      name: 'Tuberculinum',
      indicatedFor: 'Jo log baar baar chest aur respiratory infections se thak gaye hain — thin, always tired, sardi jaldi lagti hai.',
      whyItHelps: 'Homeopathy mein yeh ek powerful constitutional medicine hai jo chronic respiratory weakness aur recurrent infections ki pattern todni mein historically effective mana jaata hai. Immunity ko deep level par rebalance karta hai. Thin, restless, easily chilled patients mein especially indicated hai.',
    },
    {
      _key: 'med2',
      name: 'Arsenicum Album',
      indicatedFor: 'Jinhe baar baar naak behna, sneezing, watery discharge hoti hai — anxiety bhi hoti hai, restless rehte hain.',
      whyItHelps: 'Allergic aur infectious respiratory conditions dono mein kaam aata hai. Mucosal immunity ko strengthen karne mein help karta hai, especially naak aur upper respiratory tract mein. Anxiety + restlessness + burning discharges iska hallmark presentation hai.',
    },
    {
      _key: 'med3',
      name: 'Calcarea Carbonica',
      indicatedFor: 'Mote, thande patient — bacche ya adult — jinhein sardi jaldi lagti hai, sweat zyada aata hai, infections slow recovery wale hote hain.',
      whyItHelps: 'Ek deep-acting constitutional medicine jo sluggish immunity wale patients mein system ko activate karne ke liye use hoti hai. Specially effective in children who get repeated ear and throat infections. Fair, chilly, slow children ke liye classic remedy hai.',
    },
    {
      _key: 'med4',
      name: 'Baryta Carbonica',
      indicatedFor: 'Bacche jinhein baar baar tonsil infection hoti hai, mentally bhi thoda slow development — shy, hesitant.',
      whyItHelps: 'Tonsils aur lymphatic system ki chronic weakness ke liye specifically suited medicine — surgical intervention avoid karne mein madadgar ho sakti hai. Shy, timid, slow-to-develop children mein tonsil aur adenoid problems ke liye classic indication hai.',
    },
    {
      _key: 'med5',
      name: 'Natrum Muriaticum',
      indicatedFor: 'Jo log emotionally suppress karte hain — grief ya stress ke baad immunity weak ho gayi ho, baar baar cold sores ya naak ka infection.',
      whyItHelps: 'Stress-linked immune weakness mein deep constitutional action — emotional aur physical dono levels par. Post-viral weakness mein bhi effective. Reserved, grief-holding, salt-craving patients mein recurrent infections ke liye classic remedy hai.',
    },
  ],
  ...
  diet: {
    recommended: [
      ...
      'Garlic (lehsun) — allicin compound natural antibiotic jaise kaam karta hai',
    ],
    avoid: [
  ...
  seasonalCare: [
    {
      _key: 'monsoon',
      season: 'Monsoon (July - September) — Sabse Risky Season',
      tips: 'Bahar ka khaana bilkul band karein — street food infection risk highest is season mein. Paani ubaal ke piyein ya filtered water use karein. Geele kapde jaldi change karein — fungal infections risk. Ghar mein tulsi-ginger kadha roz — preventive dose. Bacchon ke shoes/socks baar baar check karein. Homeopathic preventive dose (doctor se puchh ke) monsoon se pehle le sakte hain.',
    },
    {
      _key: 'winter',
      season: 'Sardi (November - February)',
      tips: 'Vitamin D supplement zaroor — sardi mein sunlight kam, deficiency immunity girata hai. Garm khaana hamesha — cold food avoid karein. Raat ko muh band karke soyein — naak se breathing warm air le. Chest aur pair warm rakhein — ye body parts infection ke liye most vulnerable hain cold mein. Sarson ka tel ya coconut oil naak mein lagana (nasya) — traditional protection against dry air infections.',
    },
    {
      _key: 'summer',
      season: 'Garmi (March - June)',
      tips: 'Hydration sabse important — dehydration immunity ko kamzor karti hai. AC se bahar ki garmi mein sudden aana-jaana avoid karein — temperature shock immunity stress create karta hai. Nimbu pani, coconut water, aam panna — natural electrolytes. Cooler ke filters clean rakhein — mold growth site, respiratory infections ka common cause.',
    },
  ],
