  ...
  medicines: [
    {
      _key: 'med1',
      name: 'Carcinosin',
      forWhom: 'Autistic bachche jinmein strong family history ho cancer/tuberculosis ka, extreme fastidiousness ya disorder, routine ke liye obsession, aur emotional suppression pattern ho.',
    ...
    },
    {
      _key: 'med2',
      name: 'Stramonium',
      forWhom: 'Bacche jinmein intense fear (darkness, water, animals), sudden violent behavior episodes, night terrors, aur aggression ke saath stuttering ho — sensory overload mein scream karte hain.',
    ...
    },
    {
      ...
      forWhom: 'Slow developmental milestones wale bachche — late walker, late talker, timid, strangers se extreme shyness, concentration bahut kam, childish behavior age ke hisaab se behind.',
    ...
    },
    {
      _key: 'med4',
      name: 'Tuberculinum',
      forWhom: 'Restless, hyperactive autistic bachche jo ek jagah nahi baithe, destructive hain, travel/change pasand karte hain, chest weak ho ya family mein TB history ho.',
    ...
    },
    {
      ...
      forWhom: 'Autistic bachche jinmein gut symptoms prominent ho — bloating, loose stools, food intolerances, aur behavioral worsening after eating certain foods.',
    ...
    },
    {
      ...
      forWhom: 'Bacche jo kapde utaarne lagein, exhibitionist behavior, inappropriate laughing/crying, obscene behavior, sexual gestures — uninhibited behavior pattern.',
