...
Ye page aapko 2 minute mein batayega: aapki ghabrahat serious hai kya, ghar pe kya karein, aur kab doctor ke paas jaana zaroori hai.`,
  ...
  indiaContext: 'India mein anxiety disorder ka prevalence lagbhag 3-4% adults mein hai — lekin mild anxiety symptoms kahin zyada logon ko hote hain jo kabhi doctor ke paas nahi jaate.',
  indiaContextSource: 'Lancet / WHO — Mental Disorders Global Report | 2022',
  ...
  timeline3Days: 'Koi naya stress hai — job, family, health — aur body usse anxiety ke roop mein feel kar rahi hai. Ye natural response hai. Rest karo, trigger pehchano. Agar teen din mein better ho rahe hain to abhi doctor zaruri nahi — lekin Level 1 signs pe dhyan rakho.',
  timeline4Weeks: 'Ghabrahat baar baar aa rahi hai aur khud se nahi ja rahi — ye signal hai ki body ko extra support chahiye. Is hafte doctor se milein. Lifestyle adjustments ke saath professional guidance bhi zaroori hai is stage pe.',
  timelineMonthPlus: 'Chronic anxiety hai — ye khud se theek hone ki jagah nahi hai. Ek qualified doctor se milna zaruri hai. Homeopathy chronic anxiety mein particularly helpful approach hai — root cause address karne ke liye, sirf symptoms manage karne ke liye nahi.',

  lifestyleCauses: [
    {
      _key: 'lc1',
      causeName: 'Chronic Stress (Lagaataar Tanav)',
      ...
      howToIdentify: 'Anxiety sirf stress wale situations mein nahi, balki normal dinon mein bhi hoti hai. Neend aur bhooke pe bhi asar pad raha hota hai.',
    },
    {
      _key: 'lc2',
      causeName: 'Sleep Deprivation (Neend Ki Kami)',
      ...
      howToIdentify: 'Raat mein 6 ghante se kam so rahe hain ya neend baar baar toot rahi hai — aur din mein anxiety worse feel hoti hai.',
    },
    {
      _key: 'lc3',
      causeName: 'Caffeine aur Stimulants (Chai, Coffee, Energy Drinks)',
      ...
      howToIdentify: 'Din mein 3-4 cup se zyada chai/coffee ke baad dil tez dhadakna ya haath kaanpna notice hota hai.',
    },
    {
      _key: 'lc4',
      causeName: 'Sedentary Lifestyle (Baithne Wali Zindagi)',
      ...
      howToIdentify: 'Agar din bhar sirf baithne ka kaam hai aur shaam ko ghabrahat zyada hoti hai.',
    },
  ],
  ...
  medicalCauses: [
    {
      ...
      diseaseHindiName: 'Chinta Vikaar',
      howSymptomPresents: 'Ye diagnosis tab hoti hai jab anxiety daily life mein significant interference kar rahi ho — kaam, relationships, routine — binu kisi specific trigger ke, 6 mahine ya zyada se. Generalized Anxiety Disorder (GAD) sabse common type hai.',
      howToIdentify: 'Roz ki anxiety without clear trigger. Sleep aur concentration affected. Doctor se GAD-7 questionnaire ke through assessment hoti hai.',
    ...
    },
    {
      ...
      diseaseHindiName: 'Panic Vikaar',
      howSymptomPresents: 'Achanak aur intense wave of fear — dil tez dhadakna, saans lena mushkil, chest tight, numbness — jo 10-20 minute mein peak hoti hai. Pehli baar hone pe log heart attack samajhte hain.',
      howToIdentify: 'Sudden intense episodes. No cardiac cause on ECG. Recurring unexpected panic attacks.',
      homeopediaSlug: '',
      isAvailable: false,
    },
    {
      _key: 'mc3',
      diseaseName: 'OCD',
      diseaseHindiName: 'Jabriya Soch Vikaar',
      howSymptomPresents: 'Anxiety ke saath saath repetitive thoughts aati hain — aur unhe "neutralize" karne ke liye compulsive actions (baar baar haath dhona, check karna) karne ki need hoti hai.',
      howToIdentify: 'Intrusive recurring thoughts jo distress dein. Compulsive rituals to reduce anxiety. Time-consuming behaviour.',
    ...
    },
    {
      ...
      diseaseHindiName: 'Mansik Udaasi',
      howSymptomPresents: 'Depression aur anxiety aksar saath aate hain. Depression mein anxiety ke saath lagataar udaasi, kisi cheez mein interest na hona, energy ki kami bhi hoti hai.',
      howToIdentify: 'Persistent low mood 2+ weeks. Loss of interest in activities. PHQ-9 score elevated. Doctor se assessment zaroori.',
  ...
  homeSteps: [
    {
      _key: 'hs1',
      action: '4-7-8 Breathing Technique: 4 second saans lo, 7 second rokho, 8 second mein chhodho. Do-teen baar repeat karo.',
      whyItWorks: 'Ye pattern Vagus nerve ko stimulate karta hai jo parasympathetic nervous system (body ka "calm down" system) activate karta hai. Do-teen minutes mein heart rate slowly normal hone lagti hai.',
    },
    {
      _key: 'hs2',
      action: 'Cold Water — Face aur Wrists Pe: Thanda paani chehra aur pulse points (wrists, temples) pe lagao.',
      whyItWorks: '"Dive Reflex" trigger hoti hai — ek natural bodily response jo heart rate aur anxiety response dono ko quickly reduce karta hai. Ye physiological hai — directly nervous system pe asar karta hai.',
    },
    {
      _key: 'hs3',
      action: 'Grounding Technique — 5-4-3-2-1: 5 cheezein dekho, 4 touch karo, 3 suno, 2 sungho, 1 taste karo.',
      whyItWorks: 'Anxiety mein brain future ke baare mein sochta rehta hai. Grounding brain ko abhi ke moment mein laata hai. Ye rumination cycle todta hai.',
    },
    {
      _key: 'hs4',
      action: 'Light Movement — 10 Minute Walk: Anxiety feel ho to 10 minute ki light walk — indoors bhi theek hai.',
      whyItWorks: 'Anxiety mein body mein adrenaline release hota hai jo action ke liye hoti hai. Walk karne se ye energy physically use hoti hai. Endorphins release hote hain jo anxiety intensity reduce karte hain.',
    },
    {
      _key: 'hs5',
      action: 'Kisi Se Baat Karo: Kisi bhi trusted insaan se 5 minute baat karo — phone pe bhi theek hai.',
      whyItWorks: 'Social connection Oxytocin release karta hai — ek hormone jo anxiety aur stress response directly counteract karta hai. Akele rehna anxiety ko aur badha deta hai.',
    },
  ],
  ...
  homeopathyDiseaseLinks: [
    { _key: 'hdl1', diseaseName: 'Anxiety Disorder', diseaseSlug: 'anxiety' },
    { _key: 'hdl2', diseaseName: 'OCD (Obsessive Compulsive Disorder)', diseaseSlug: 'obsessive-compulsive-disorder' },
    { _key: 'hdl3', diseaseName: 'Depression', diseaseSlug: 'depression' },
  ],

  linkedDiseaseCards: [
    { _key: 'ldc1', title: 'Anxiety Disorder', hindiName: 'Chinta Vikaar', slug: 'anxiety' },
    { _key: 'ldc2', title: 'OCD', hindiName: 'Jabriya Soch Vikaar', slug: 'obsessive-compulsive-disorder' },
    { _key: 'ldc3', title: 'Depression', hindiName: 'Mansik Udaasi', slug: 'depression' },
  ],
  ...
  sources: [
    { _key: 'src1', name: 'World Health Organization — Mental Disorders: Anxiety', year: '2023', url: 'https://www.who.int/news-room/fact-sheets/detail/mental-disorders' },
    { _key: 'src2', name: 'Mayo Clinic — Anxiety Disorders: Symptoms & Causes', year: '2024', url: 'https://www.mayoclinic.org/diseases-conditions/anxiety/symptoms-causes/syc-20350961' },
    { _key: 'src3', name: 'NCBI / PubMed — Anxiety Disorders: A Review of Current Literature', year: '2020', url: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6296480/' },
    { _key: 'src4', name: 'NHS UK — Generalised Anxiety Disorder in Adults', year: '2023', url: 'https://www.nhs.uk/mental-health/conditions/generalised-anxiety-disorder/overview/' },
  ],

  quickFactSymptom: 'Anxiety ke physical symptoms — jaise dil tez dhadakna, haath kaanpna — real hote hain. Ye sirf "mann ki baat" nahi hai. Nervous system ki direct response hai.',
  quickFactIndiaStats: 'WHO ke mutabik India mein 3-4 crore se zyada log anxiety disorders se affected hain.',
  quickFactDoctorWhen: 'Agar anxiety 2 hafte se zyada binu improvement ke hai, ya daily life affect kar rahi hai — doctor se milna zaroori hai.',
