...
const doc = {
  ...
  symptoms: [
    {
      _key: 'sym1',
      category: 'Silent & Moderate Stage Symptoms',
      items: [
        'Hamesha thakaan rehna – kaam ke baad bhi rest se theek na hona',
        'Pet ke upar daayein taraf halka bhaari pan ya discomfort',
        'Subah uthke bhi fresh na rehna',
        'Bina reason ke wajan badh jaana',
        'Bloating aur gas – khaane ke baad pet bhaari lagta hai',
        'Appetite mein kami – khaane ka mann nahi karta',
        'Nausea – especially fatty food ke baad',
        'Skin ya aankhon mein halki peelaahat – jaundice ka early sign',
      ],
    },
    {
      _key: 'sym2',
      category: 'Advanced Stage Symptoms',
      items: [
        'Paon ya tobbon mein sujan – water retention',
        'Aankhein ya skin clearly yellow hona',
        'Dark urine – chaay jaise rang ka peshab',
        'Severe abdominal pain',
        'Confusion ya mental fog extreme level par',
      ],
    },
  ],
