...
Aap akele nahi hain — India mein karodo log ghutno me dard se rozana guzarte hain. Ye page 2 minute mein batayega: aapka case serious hai ya nahi, aur agli step kya honi chahiye.`,
  ...
  indiaContext: 'WHO ke mutabiq musculoskeletal conditions — jisme ghutne ka dard bhi aata hai — globally disability ka doosra sabse bada karan hain. India mein 40 saal ke upar ki population mein osteoarthritis se related ghutne ka dard bahut common hai — khaaskar mahilaon mein.',
  indiaContextSource: 'WHO — Musculoskeletal Health Fact Sheet | 2023',
  ...
  timeline3Days: 'Aksar koi physical activity, galat position, ya halki chot ki wajah se hota hai. Body apne aap ko repair karne ki koshish kar rahi hai. Rest karo, ice lagao. Agar 3 din mein better nahi hua to Level 2 mein aao.',
  timeline4Weeks: 'Ye signal hai ki sirf muscle strain nahi hai — andar kuch aur chal raha hai. Cartilage, tendon, ya koi underlying condition ho sakti hai. Is hafte doctor se milna zaroori hai.',
  timelineMonthPlus: 'Ye chronic condition ka sign hai — osteoarthritis ya rheumatoid arthritis sabse common causes hain is stage pe. Doctor se milna aur proper diagnosis lena zaroori hai. Homeopathy chronic ghutne ke dard mein — jab cause clear ho — root level pe kaam karti hai, results individual hote hain.',
  ...
  lifestyleCauses: [
    {
      ...
      howToIdentify: 'Dono ghutne dard karte hain. Chalte chalte ya seedhiyan utarne ke baad zyada hota hai.',
    },
    {
      _key: 'lc2',
      causeName: 'Kum Physical Activity / Muscles Ka Kamzor Hona',
      ...
      howToIdentify: 'Seedhiyan chadhne mein zyada problem. Kaafi der baithe rehne ke baad uthte waqt dard.',
    },
    {
      _key: 'lc3',
      causeName: 'Galat Posture Ya Footwear',
      mechanism: 'High heels, flat chappals bina support ke, ya galat tarike se chalte rehna — ye sab ghutne ke alignment pe asar daalta hai. Over time joint uneven tarike se ghista hai.',
      howToIdentify: 'Ek hi ghutna zyada dard karta hai. Jab footwear badlate hain to thoda fark padata hai.',
    },
    {
      _key: 'lc4',
      causeName: 'Zyada Use / Overexertion',
      ...
      howToIdentify: 'Exercise ke baad ya agle din dard hota hai. Rest se better hota hai.',
    },
  ],
  ...
  medicalCauses: [
    {
      ...
      diseaseHindiName: 'Gathiya / Jodon Ki Sujan',
      howSymptomPresents: 'Sujan ke saath dard hota hai — ghutna garam bhi lagta hai. Subah akadpan zyada rehta hai. Dono ghutne aksar dard karte hain.',
      howToIdentify: 'Subah ki akadpan 30+ minute. Ghutna touch pe garam lagta hai. Blood test mein RA factor ya high CRP.',
    ...
    },
    {
      ...
      diseaseHindiName: 'Haddi Ka Ghisna',
      howSymptomPresents: 'Dheere dheere develop hota hai — pehle seedhiyan mein, phir chalte waqt bhi. Ghutna chalte waqt creak karta hai. 50 saal se upar age mein zyada common.',
      howToIdentify: '50+ age. Seedhiyan mein dard badhta hai. X-ray mein joint space kam dikhta hai.',
    ...
    },
    {
      _key: 'mc3',
      diseaseName: 'Gout',
      diseaseHindiName: 'Vaat Rog / Yoorik Acid',
      howSymptomPresents: 'Achanak bahut tez dard — aksar raat ko. Ghutna bahut laal aur garam ho jaata hai.',
      howToIdentify: 'Raat ko uthane wala dard. Blood test mein uric acid high. Diet mein meat/beer zyada.',
      homeopediaSlug: 'gout',
      isAvailable: true,
    },
    {
      _key: 'mc4',
      diseaseName: 'Ligament Injury',
      diseaseHindiName: 'Ligament Ki Chot',
      howSymptomPresents: 'Chot ke fauran baad tez dard aur sujan. Ghutna unstable lagta hai. Sports ya accident ke baad hota hai.',
      howToIdentify: 'Clear injury history. Ghutna side se press karne pe zyada dard. MRI se confirm hota hai.',
      homeopediaSlug: '',
      isAvailable: false,
    },
  ],
  ...
  homeSteps: [
    {
      _key: 'hs1',
      action: 'RICE Method — Pehle 48-72 Ghante: R = Rest (ghutne ko aaraam do), I = Ice (20 min har 2 ghante cold pack), C = Compression (light bandage), E = Elevation (ghutne ko thoda upar rakhein soote waqt).',
      whyItWorks: 'Sujan aur inflammation ko fauran control karta hai. Joint ko heal hone ka waqt milta hai.',
    },
    {
      _key: 'hs2',
      action: 'Ghutne Ko Seedha Rakhne Wali Position: Soote waqt ghutne ke neeche ek folded towel ya pillow rakhein.',
      whyItWorks: 'Ghutne ka pressure reduce hota hai. Muscles relax hoti hain — healing mein help milti hai.',
    },
    {
      _key: 'hs3',
      action: 'Garam Paani Ki Senkaan (Sirf Swelling Na Ho Tab): Agar sujan nahi hai — sirf dard hai — to warm compress lagaao 15-20 minute ke liye.',
      whyItWorks: 'Garam senkaan muscles ko relax karti hai aur blood circulation badhati hai.',
    },
    {
      _key: 'hs4',
      action: 'Chair Pe Baith Ke Gentle Leg Raise: Seedha baithein, ek paanv ko slowly upar uthaein aur 5 second rokein, phir neeche laayein. 10 baar karein.',
      whyItWorks: 'Thigh muscles ko activate karta hai bina ghutne pe direct pressure daale. Support badhta hai.',
    },
    {
      _key: 'hs5',
      action: 'Seedhiyan Charhne Se Temporarily Bachein: Jab tak dard hai, seedhiyan minimize karein.',
      whyItWorks: 'Seedhiyan ghutne pe sabse zyada pressure daalta hai — rest karne se faster recovery.',
    },
  ],

  homeopathyIndividualization: 'Ghutne ke dard ka naam ek hai — lekin wajah aur experience har insaan mein alag hoti hai. Kisi ka dard subah zyada hota hai — "jab tak chalein thoda loose ho jaata hai." Kisi ka raat ko uthata hai. Kisi ko garm mausam mein zyada, kisi ko sardi mein. Kisi ko chalne se better hota hai, kisi ko rest se. Homeopathy mein ye sab differences matter karte hain — aapka ghutne ka dard aapke jaisa hai, treatment bhi aapke hisaab se hogi.',
  homeopathyRootCause: 'Ghutne ka dard baar baar aana — ya chronically rehna — sirf joint ka issue nahi hota. Aksar puri body mein koi deeper imbalance hota hai — inflammatory response, uric acid metabolism, ya immune system — jo surface pe ghutne ke roop mein dikhta hai. Homeopathy mein sirf dard band karna goal nahi — us cheez ko address karna hota hai jo is pattern ko baar baar la rahi hai. Waqt ke saath frequency aur intensity dono kam hoti hain. Research is area mein limited hai aur results individual hote hain.',
  ...
  homeopathyDiseaseLinks: [
    { _key: 'hdl1', diseaseName: 'Arthritis (Gathiya)', diseaseSlug: 'arthritis' },
    { _key: 'hdl2', diseaseName: 'Osteoarthritis (Haddi Ka Ghisna)', diseaseSlug: 'osteoarthritis' },
    { _key: 'hdl3', diseaseName: 'Gout (Yoorik Acid)', diseaseSlug: 'gout' },
  ],

  linkedDiseaseCards: [
    { _key: 'ldc1', title: 'Arthritis', hindiName: 'Gathiya / Jodon Ki Sujan', slug: 'arthritis' },
    { _key: 'ldc2', title: 'Osteoarthritis', hindiName: 'Haddi Ka Ghisna', slug: 'osteoarthritis' },
    { _key: 'ldc3', title: 'Gout', hindiName: 'Vaat Rog / Yoorik Acid', slug: 'gout' },
  ],
  ...
  sources: [
    { _key: 'src1', name: 'WHO — Musculoskeletal Health Fact Sheet', year: '2023', url: 'https://www.who.int/news-room/fact-sheets/detail/musculoskeletal-conditions' },
    { _key: 'src2', name: 'Mayo Clinic — Knee Pain: Symptoms and Causes', year: '2024', url: 'https://www.mayoclinic.org/symptoms/knee-pain/basics/causes/sym-20050688' },
    { _key: 'src3', name: 'NCBI / NIH — Osteoarthritis Overview', year: '2023', url: 'https://www.ncbi.nlm.nih.gov/books/NBK482326/' },
    { _key: 'src4', name: 'NHS — Knee Pain', year: '2023', url: 'https://www.nhs.uk/conditions/knee-pain/' },
  ],

  quickFactSymptom: 'Ghutne mein dard India ki 40+ age group mein sabse common joint complaint hai.',
  quickFactIndiaStats: 'WHO ke mutabiq 15% se zyada adults musculoskeletal pain se affected hain jisme knee pain bhi shamil hai.',
  quickFactDoctorWhen: '1 hafte se zyada dard, sujan, ya ghutna lock ho — turant doctor.',
