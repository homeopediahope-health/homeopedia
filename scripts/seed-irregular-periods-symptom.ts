...
Ye page aapko 2 minute mein batayega: aapka case ghar pe manage ho sakta hai ya doctor zaruri hai — aur aage kya karna chahiye.`,
  ...
  indiaContext: 'WHO ke anusaar globally lagbhag 14-25% reproductive age ki mahilaon ko irregular periods ki problem hoti hai. India mein PCOS aur thyroid ki badh rahi cases ki wajah se ye percentage aur zyada estimate ki jaati hai.',
  indiaContextSource: 'WHO — Menstrual Health: Global Landscape | 2023',
  ...
  timeline3Days: 'Body external changes pe react karti hai — stress, travel, exam, diet change, ya exercise mein sudden badlaav se ek-do cycles irregular ho jaana common hai. Ye aksar khud theek ho jaata hai jab woh trigger khatam hota hai.',
  timeline4Weeks: 'Ye ab sirf "stress ki wajah se" ki category se bahar ho chuka hai. Is duration mein hormones properly check karna zaroori hai. PCOS, thyroid, ya hormonal imbalance rule out karna chahiye. Is hafte hi doctor appointment lo — delay mat karo.',
  timelineMonthPlus: 'Agar irregularity 4+ mahine se chal rahi hai to ye chronic hai. Iska matlab hai ki body mein koi deeper imbalance hai jo sirf "wait and watch" se theek nahi hoga. Doctor se milna aur proper diagnosis lena ab optional nahi — mandatory hai.',
  ...
  lifestyleCauses: [
    {
      ...
      howToIdentify: 'Irregularity kisi besar ya stressful period ke saath coincide karti hai — exams, breakup, job change, family tension. Jab stress kam hoti hai cycle slowly better hoti hai.',
    },
    {
      _key: 'lc2',
      causeName: 'Sudden Weight Change (Zyada Badhna Ya Ghatta)',
      ...
      howToIdentify: 'Irregularity weight change ke 1-3 mahine baad start hoti hai. BMI normal range se bahut upar ya neeche hone pe zyada hota hai.',
    },
    {
      _key: 'lc3',
      causeName: 'Extreme Exercise',
      ...
      howToIdentify: 'Marathon training, intense dance, ya gym daily 2+ ghante karne ke baad cycles miss hone lagi hain. Weight bhi neeche hai.',
    },
    {
      _key: 'lc4',
      causeName: 'Sleep Disruption (Raat Ko Jaagna)',
      ...
      howToIdentify: 'Jo log night shift mein hain, students jo raat ko jagte hain, ya recent travel ke baad (jet lag) irregularity notice karte hain.',
    },
  ],
  ...
  medicalCauses: [
    {
      _key: 'mc1',
      diseaseName: 'PCOD',
      diseaseHindiName: 'Andiyon Mein Chhoti Ganthe',
      howSymptomPresents: 'PCOD mein ovulation regular nahi hoti isliye cycle track nahi rehta. Saath mein acne, face ya body pe extra hair growth, aur weight gain aksar hota hai.',
    ...
    },
    {
      _key: 'mc2',
      diseaseName: 'PCOS',
      diseaseHindiName: 'Andiyon Ki Bimari (Hormonal)',
      howSymptomPresents: 'PCOS mein zyada hormonal imbalance hoti hai — testosterone elevated hota hai, insulin resistance bhi aa sakti hai. Periods kai mahine tak miss ho sakte hain.',
      howToIdentify: 'Blood test mein elevated androgens (testosterone). Fasting insulin high. Rotterdam criteria se diagnosis hoti hai.',
      homeopediaSlug: 'pcod',
      isAvailable: true,
    },
    {
      ...
      diseaseHindiName: 'Thayraid Ki Bimari',
      howSymptomPresents: 'Hypothyroidism mein periods heavy aur irregular hoti hain. Hyperthyroidism mein periods bahut kam ya miss ho sakti hain. TSH blood test se confirm hota hai.',
      howToIdentify: 'TSH blood test abnormal. Saath mein fatigue, weight change, hair fall bhi hoti hai. Thyroid gland check karo.',
    ...
    },
    {
      ...
      diseaseHindiName: 'Harmon Ki Gadbadi',
      howSymptomPresents: 'Estrogen, progesterone, prolactin, ya FSH/LH ka ratio bigad jaane se cycle poori tarah untrack ho jaati hai. Mood swings, breast tenderness, aur bloating common hain.',
      howToIdentify: 'Hormone panel blood test (LH, FSH, prolactin, estradiol) abnormal aata hai. Doctor se confirm karo.',
      homeopediaSlug: '',
      isAvailable: false,
    },
  ],
  ...
  homeSteps: [
    {
      _key: 'hs1',
      action: 'Sleep Schedule Regular Karo: Raat 10-11 baje sone ki koshish karo — ek fixed time choose karo. Irregular sleep hormonal clock ko directly disturb karti hai.',
      whyItWorks: 'Melatonin aur cortisol ke levels normalize hote hain — jo hypothalamus ke hormonal signals ko stabilize karte hain. Sirf 2-3 hafte ki consistent sleep se bhi cycle better hone lag sakti hai.',
    },
    {
      _key: 'hs2',
      action: 'Stress Ko Identify Karo — Ignore Mat Karo: Sirf 10-15 minute daily — chahe slow walk ho, deep breathing ho, ya diary likhna ho.',
      whyItWorks: 'Stress ka acknowledgement hi cortisol ko kam karne ki taraf pehla step hai. Hypothalamus pe cortisol ka load kam hota hai — GnRH signal better hota hai.',
    },
    {
      _key: 'hs3',
      action: 'Warm Compress Abdomen Pe (Period Ke Waqt): Agar periods aa rahi hain lekin painful ya irregular flow hai to lower abdomen pe warm water bottle rakhein — 15-20 minute.',
      whyItWorks: 'Pelvic area mein blood flow better hota hai — cramping aur discomfort kam hoti hai.',
    },
    {
      _key: 'hs4',
      action: 'Hydration Maintain Karo: Din mein 8-10 glass paani. Dehydration hormonal processes ko slow karta hai — aksar simple cheez hoti hai jo log ignore karte hain.',
      whyItWorks: 'Cellular processes aur hormone transport dono ke liye adequate hydration zaroori hai.',
    },
    {
      _key: 'hs5',
      action: 'Cycle Track Karo — Guess Mat Karo: Ek simple calendar ya period tracking app (Flo, Clue) use karo. Dates likhna shuru karo.',
      whyItWorks: 'Pattern visible hota hai — trigger identify karna aasaan hota hai. Jab doctor ke paas jaoge to ye data unke liye bahut helpful hoga.',
    },
  ],

  homeopathyIndividualization: 'Irregular periods ka naam ek hai — lekin wajah aur presentation har mahila mein alag hoti hai. Kisi ko periods 2 mahine baad aati hain — kaafi heavy. Kisi ko 3-4 mahine miss hoti hain — aur jab aati hain to bahut painful. Kisi ko cycle chhota ho gaya hai — 18-20 din. Homeopathy mein sirf "irregular periods" nahi dekha jaata — aapka pattern, kab kaise badalta hai, kya cheez se better ya worse hoti hai, kitne saal se hai, saath mein kya aur hota hai — ye sab treatment decide karta hai.',
  homeopathyRootCause: 'Jo mahilayein kaafi saalon se irregular periods se pareshan hain unhe aksar sirf hormone pills diye jaate hain — jo band karne ke baad problem wapas aa jaati hai. Homeopathy ka approach ye hai ki irregular periods sirf ek symptom hai — uski wajah (PCOS, thyroid, stress-driven hormonal shift) ko address karna zaroori hai. Sirf cycle regular dikhaana goal nahi hota — underlying pattern ko sambhalna hota hai. Research limited hai aur results individual hote hain — lekin constitutional approach mein long-term improvement aksar dekhi jaati hai.',
  homeopathySafety: 'Irregular periods aksar young girls, newly married mahilaon, ya pregnancy plan kar rahi mahilaon mein aati hai — in sab situations mein koi strong hormonal intervention sahi nahi lagti. Homeopathy highly diluted medicines use karta hai — side effects practically nahi hote. Ye conventional treatment ke saath saath bhi safely chal sakti hai. Important: Severe cases mein — jaise 6+ mahine se periods nahi, ya ultrasound mein kuch significant hai — conventional diagnosis aur treatment pehle aani chahiye. Homeopathy complementary role mein hai — replacement nahi.',
  ...
  linkedDiseaseCards: [
    { _key: 'ldc1', title: 'PCOD', hindiName: 'Andiyon Mein Chhoti Ganthe', slug: 'pcod' },
    { _key: 'ldc2', title: 'Thyroid Disorder', hindiName: 'Thayraid Ki Bimari', slug: 'thyroid' },
  ],
  ...
  sources: [
    { _key: 'src1', name: 'WHO — Menstrual Health: A Global Landscape', year: '2023', url: 'https://www.who.int/publications/i/item/9789240062115' },
    { _key: 'src2', name: 'Mayo Clinic — Irregular Periods: Causes, Symptoms & Treatment', year: '2024', url: 'https://www.mayoclinic.org/symptoms/irregular-periods/' },
    { _key: 'src3', name: 'NCBI / PubMed — Menstrual Cycle Irregularities and Their Association with PCOS, Thyroid, and Stress', year: '2023', url: 'https://pubmed.ncbi.nlm.nih.gov/' },
    { _key: 'src4', name: 'NHS UK — Irregular Periods: Patient Information', year: '2023', url: 'https://www.nhs.uk/conditions/irregular-periods/' },
  ],

  quickFactSymptom: 'Ek normal menstrual cycle 21-35 din ka hota hai. Isse bahar jaana consistently = irregular.',
  quickFactIndiaStats: 'India mein PCOS — irregular periods ka ek major cause — reproductive age ki 1 mein se 5 mahila ko affect karta hai.',
  quickFactDoctorWhen: '3 consecutive cycles skip hone pe, ya 2+ mahine consistently 35+ din ka cycle hone pe — doctor zaroori.',
