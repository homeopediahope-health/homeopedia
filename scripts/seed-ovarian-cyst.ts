...
const doc = {
  ...
  medicines: [
    {
      _key: 'med1',
      name: 'Apis Mellifica',
      indicatedFor: 'Right ovary mein cyst, burning ya stinging type ka dard, touch se dard badhta ho, bloating ho.',
      whyItHelps: 'Apis ovarian inflammation aur fluid accumulation mein kaam karta hai — especially jab right side zyada affected ho aur dard jalane wala ho. Sting jaisi burning sensation aur swelling iska characteristic indication hai.',
    },
    {
      _key: 'med2',
      name: 'Lachesis',
      indicatedFor: 'Left ovary ki cyst, periods ke pehle dard zyada ho, periods shuru hote hi thoda better lage — jealous ya intense nature wali mahilaon mein.',
      whyItHelps: 'Lachesis left-sided ovarian issues mein aur hormonal transitions (pre-menstrual, peri-menopausal) mein effective maana jaata hai. Pre-menstrual symptom worsening jo periods se better ho — ye iska hallmark indication hai.',
    },
    {
      _key: 'med3',
      name: 'Pulsatilla',
      indicatedFor: 'Irregular, delayed, ya suppressed periods wali — mild, emotional, weeping nature — zyada thirst nahi — warm room mein bura lagta ho.',
      whyItHelps: 'Pulsatilla hormonal irregularities ke saath ovarian problems mein classical medicine hai — especially young girls mein periods establish karne mein bhi use hoti hai. Changeable, shifting symptoms aur mild yielding nature iska keynote hai.',
    },
    {
      _key: 'med4',
      name: 'Colocynthis',
      indicatedFor: 'Left ovary mein cramping, colicky dard — dard mein ghutne chest se lagao to aaram mile — periods ke saath severe pain.',
      whyItHelps: 'Ovarian neuralgia aur cramping pain mein Colocynthis bahut reliable medicine hai — especially left-sided, doubling-up pain mein. Pressure aur bending forward se relief milna iska characteristic feature hai.',
    },
    {
      _key: 'med5',
      name: 'Lycopodium',
      indicatedFor: 'Right ovary cyst with bloating, gas, 4-8 pm mein symptoms worse — digestive issues saath mein ho — anxious nature.',
      whyItHelps: 'Lycopodium right ovarian issues aur associated digestive-hormonal axis problems mein kaam karta hai — liver function bhi support karta hai jo hormones metabolize karta hai. Evening aggravation aur bloating iska strong indication hai.',
    },
    {
      _key: 'med6',
      name: 'Thuja Occidentalis',
      indicatedFor: 'Dermoid cyst type ya slow-growing, hard cysts — polyps ya growths ka history ho — vaccination ke baad symptoms start hue hon.',
      whyItHelps: 'Thuja abnormal tissue growth aur cystic conditions mein use hoti hai — chronic cases mein deep-acting constitutional medicine hai. Growths, warts, polyps, aur abnormal formations — ye Thuja ke characteristic indications hain.',
    },
  ],
  ...
  diet: {
    recommended: [
      ...
      'Broccoli, gobhi, patta gobhi — cruciferous vegetables estrogen metabolism improve karte hain, cyst-promoting hormones kam hote hain',
      'Palak, methi, saag — iron aur folate se anemia avoid hoti hai jo heavy periods wali mahilaon mein common hai',
      'Amla, nimbu — Vitamin C se antioxidant support milta hai, ovarian health ke liye',
      'Akhrot, badam, flaxseeds — omega-3 se prostaglandin balance hota hai, period pain kam hoti hai',
      'Rajma, chana, dal — plant protein se blood sugar stable rehta hai, insulin resistance kam hoti hai',
      'Oats, brown rice, bajra — fiber se excess estrogen gut se eliminate hota hai — hormonal balance ke liye zaroori',
      'Dahi, chaach — probiotics se gut health improve hoti hai jo directly hormonal health se connected hai',
    ...
    avoid: [
      ...
      'Red meat zyada matra mein — saturated fat se estrogen levels disturb hote hain — limit karo',
      'Alcohol — liver ko affect karta hai jo hormones metabolize karta hai — regular drinking cysts ko worsen kar sakta hai',
  ...
  seasonalCare: [
    {
      ...
      tips: 'Hydration pe special focus — dehydration se hormonal stress badh sakta hai. Coconut water aur nimbu pani helpful — natural electrolytes. Tight clothing avoid karein — pelvic area mein heat aur pressure cyst discomfort badha sakta hai. Outdoor exercise early morning mein karein — garmi mein exercise kam mat karo, time badlo.',
    },
    {
      _key: 'monsoon',
      season: 'Monsoon (July - September)',
      tips: 'Infection risk zyada hoti hai — hygiene pe extra dhyan. Fried, bahar ka khana avoid — gut health aur hormonal balance ke liye. Damp environment mein fungal infections ka risk — cotton underwear use karein. Regular checkup miss mat karo is season mein — hormonal fluctuations monsoon mein common.',
    },
    {
      _key: 'winter',
      season: 'Sardi (October - February)',
      tips: 'Period pain sardi mein zyada feel hoti hai — warm compress pelvic area pe helpful. Vitamin D supplement ya dhoop — Vitamin D deficiency ovarian health ko directly affect karta hai. Indoor exercise maintain karein — yoga, walking. Hot water bottles se relief lein — muscle relaxation se cramping kam hoti hai.',
    },
    {
      _key: 'allseason',
      season: 'Saare Mausam — Har Waqt Yaad Rakhein',
      tips: 'Monthly self-awareness — period diary rakho, changes note karo. Ultrasound follow-up apne doctor ke schedule ke hisaab se miss mat karo. Stress management consistent rakho — cortisol har season mein cysts ke liye problem hai.',
    },
  ],
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: 'Common homeopathic medicines mein Apis Mellifica (right-sided cyst, burning pain), Lachesis (left-sided, premenstrual worsening), Pulsatilla (irregular periods, mild nature), Colocynthis (severe cramping, left side), Lycopodium (right side, bloating), aur Thuja (dermoid ya slow-growing cysts) hain. Lekin ye generic list hai — aapki cyst ka size, type, location, symptoms aur nature milaakar ek qualified homoeopath hi sahi medicine decide kar sakta hai. Ek hi symptom mein 2-3 medicines fit ho sakti hain, galat medicine lene se fayda nahi hota.',
    },
    {
      _key: 'faq9',
    ...
    },
    {
      ...
      answer: 'Kuch supportive home measures helpful hain: (1) Warm compress (hot water bottle) pelvic area pe — muscle spasm aur cramping se relief milti hai. (2) Haldi wala doodh raat ko — curcumin anti-inflammatory hai. (3) Castor oil pack — traditional home remedy, pelvic circulation improve karna. (4) Stress reduction: yoga, deep breathing, adequate sleep. (5) Sugar aur maida band karo. Ye upay supportive hain — PRIMARY treatment replace nahi karte. Ultrasound se diagnosis aur doctor ki guidance ke saath hi gharelu upay karo, iske bina nahi.',
    },
  ],

  sources: [
    'Central Council for Research in Homoeopathy (CCRH), New Delhi — Clinical Research Publications | www.ccrhindia.nic.in',
    'American College of Obstetricians and Gynecologists (ACOG) — Ovarian Cysts Practice Bulletin | 2023',
    'National Health Service UK (NHS) — Ovarian Cyst Information | www.nhs.uk | 2023',
    'WHO — Reproductive Health Data | Global Burden of Disease Study, Lancet | 2022',
    'Journal of Minimally Invasive Gynecology — Conservative Management of Ovarian Cysts | 2021',
    'Indian Journal of Homoeopathic Medicine — Case Studies in Gynecological Conditions | Various years',
  ],
