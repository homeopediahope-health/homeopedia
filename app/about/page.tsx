  ...
  return (
    <div className="page-in" style={{ paddingTop: 66, background: 'var(--bg)', minHeight: '100vh' }}>
      ...
      <div style={{ background: 'linear-gradient(135deg,var(--bg) 60%,var(--bg2) 100%)', borderBottom: '1px solid var(--border)', padding: '72px clamp(16px,4vw,32px)', textAlign: 'center' }}>
        ...
        <div style={{ fontSize: 14, color: 'var(--gold-dk)', fontStyle: 'italic', marginBottom: 16 }}>MD Homoeopath · Reg. No. 54130 · Maharashtra Council of Homoeopathy</div>
        <div style={{ display: 'flex', gap: 8, justifyContent: 'center', flexWrap: 'wrap' }}>
          {['15+ Years Experience', '10,000+ Patients', 'MD Homoeopath', 'Maharashtra Council of Homoeopathy'].map(b => (
