...
const ALL_DISEASES = [
  ...
  { slug: 'worm-infestation',      title: 'Worm Infestation',         hindi: 'पेट के कीड़े / आंत के परजीवी',  cat: 'Digestive',   min: 9,  hot: true,  h: 'pet ke keede bachchon mein keede pinworm roundworm hookworm deworming homeopathy cina' },
  // Mental
