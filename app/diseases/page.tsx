...
const ALL_DISEASES = [
  ...
  { slug: 'worm-infestation',      title: 'Worm Infestation',         hindi: 'Intestinal Worms / Pet Worms',   cat: 'Digestive',   min: 9,  hot: true,  h: 'pet worms intestinal worms pinworm roundworm hookworm deworming bacchon homeopathy cina' },
  // Mental
